 ...
 * 따라서 index.js 모듈의 
 * (req,res) => {res.rendr("home/login");} 부분이 controller라고 할 수 있다. 
 * 
 * 분리하는 과정은 다음과 같다.
 * - 먼저 routes/home 경로에 home.ctrl.js 모듈을 생성한다.
 * - 그 안에 hello 라는 컨트롤러 함수를 만들고 이를 외부에서 사용할 수 있도록 한다.
 * - index.js 모듈에서 컨트롤러에 해당하는 부분을 잘라낸 후 hello 컨트롤러 함수에 대입한다. 
*/
